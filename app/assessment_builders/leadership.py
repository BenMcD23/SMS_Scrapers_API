...
if __name__ == "__main__":
    example_payload = {
        "cadet_name": "Cdt. Jane Smith",
        "exercise_no": "Ex 04",
        "exercise_name": "Urban Recon",
        "scores": {1: 2, 2: 2, 3: 5, 4: 5, 5: 5, 6: 4, 7: 3, 8: 3, 9: 2, 10: 5},
        "total_score": 36,
        "passed": False,
        "assessor_name": "WO1 Brown",
        "assessor_signature": "Brown.A",
        "date": "04/03/2026",
        "debriefing_notes": "Excellent command dwadwadwadwadwadwadwa wdawdv presence. Successfully navigated the team through the obstacle course ahead of schedule."
    }
    
    pdf_output = generate_leadership_pdf(example_payload)
    with open("test_filled_assessment.pdf", "wb") as f:
        f.write(pdf_output)
    print("Done! Check 'test_filled_assessment.pdf'")